...
},{"./accessors.js":3,"./build.js":7,"./parameters.js":20,"./postprocess":21,"./postprocessors":22}],2:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./parameters.js":20}],4:[function(require,module,exports){
var reductio_alias = {
...
var reductio_hash = require('./hash.js');
...
function build_function(p, f, path) {
  ...
  if(p.hash) {
    f.reduceAdd = reductio_hash.add(p.hash, f.reduceAdd, path);
    f.reduceRemove = reductio_hash.remove(p.hash, f.reduceRemove, path);
    f.reduceInitial = reductio_hash.initial(f.reduceInitial, path);
  }
...
},{"./alias.js":4,"./aliasProp.js":5,"./avg.js":6,"./count.js":9,"./data-list.js":10,"./exception-count.js":11,"./exception-sum.js":12,"./filter.js":13,"./hash.js":14,"./histogram.js":15,"./max.js":16,"./median.js":17,"./min.js":18,"./nest.js":19,"./std.js":24,"./sum-of-squares.js":25,"./sum.js":26,"./value-count.js":27,"./value-list.js":28}],8:[function(require,module,exports){
